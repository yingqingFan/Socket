...
public class ClientDemoTest2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ClientDemoTest2 clientDemoTest2 = new ClientDemoTest2();
        clientDemoTest2.clientId = clientId;
        Socket socket = clientDemoTest2.initClient();
        //检测心跳重连
        clientDemoTest2.new HeatBeat(socket).start();
        if(socket!=null){
            //接收消息
            clientDemoTest2.receiveMessage(socket);
            //发送消息
            clientDemoTest2.sendMessage();
        }
    }
